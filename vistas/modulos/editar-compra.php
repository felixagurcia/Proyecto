                    ...
                    <form role="form" method="post" class="formularioCompra">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box">
                                ...
                                $venta = ControladorTransaccion::ctrMostrarTransaccion($item, $valor, $trans);
                                ...
                                $itemCliente = "id";
                                $valorCliente = $venta["cod_persona"];
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="nuevaCompra" name="editarTransaccion"
                                               value="<?php echo $venta["id"]; ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" id="seleccionarCliente" name="seleccionarCliente" required>
                                            ...
                                            $stmt=Modeloproveedores::mostrartProveedores();
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 50%">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="hidden" class="form-control input-lg" min="0"
                                                               id="nuevoImpuestoCompra" name="nuevoImpuestoCompra"
                                                               value="<?php echo $porcentajeImpuesto; ?>" required>
...
<!--                                                                    class="ion ion-social-usd"></i></span>-->
                                                        ...
                                                        <input type="hidden" class="form-control input-lg"
                                                               id="nuevoTotalTransaccion" name="nuevoTotalTransaccion"
                                                               total="<?php echo $venta["total"]; ?>"
                                                               value="<?php echo $venta["total"]; ?>" readonly required>

                                                        <input type="hidden" name="totalTransaccion"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-xs-4" style="padding-right:0px">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control" id="nuevoMetodoPago" name="nuevoMetodoPago" required="">
                                                ...
                                                <option value="<?php echo $venta["metodo_pago"]; ?>" selected> Efectivo</option>
                                    ...
                                    <div class="cajasMetodoPago"><div class="col-xs-4"><div class="input-group"><span class="input-group-addon"><i class="ion ion-social-usd"></i></span><input type="text" class="form-control" id="nuevoValorEfectivo" name="nuevoValorEfectivo" placeholder="000000" value="" required=""></div></div><div class="col-xs-4" id="capturarCambioEfectivo" style="padding-left:0px"><div class="input-group"><span class="input-group-addon"><i class="ion ion-social-usd"></i></span><input type="text" class="form-control" id="nuevoCambioEfectivo" placeholder="000000" readonly="" required=""></div></div></div>

                                    <input type="hidden" id="listaMetodoPago" name="listaMetodoPago" value="1-undefined">
...
<!--                                </div>-->
                    ...
                    $editarVenta = new ControladorTransaccion();
                    $editarVenta->ctrEditarTransaccion(2);
