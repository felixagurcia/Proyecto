...
var table2 = $('.tablaAjustes').DataTable({
...
/*=============================================
AGREGANDO PRODUCTOS A LA Ajuste DESDE LA TABLA
=============================================*/
...
/*=============================================
QUITAR PRODUCTOS DE LA Ajustes Y RECUPERAR BOTÓN
=============================================*/

$(".FormularioAjuste").on("click", "button.quitarProducto", function(){
...
$(".FormularioAjuste").on("change", "select.nuevaDescripcionProducto", function(){
...
$(".FormularioAjuste").on("change", "input.nuevaCantidadProducto", function(){
...
function agregarImpuesto(){
	...
	var impuesto = $("#nuevoImpuestoAjuste").val();
	var precioTotal = $("#nuevoTotalAjsute").attr("total");

	var precioImpuesto = Number(precioTotal * impuesto/100);

	var totalConImpuesto = Number(precioImpuesto) + Number(precioTotal);

	$("#nuevoTotalAjuste").val(totalConImpuesto);

	$("#totalAjuste").val(totalConImpuesto);
...
$("#nuevoImpuestoAjuste").change(function(){
...
$("#nuevoTotalAjuste").number(true, 2);
...
CAMBIO EN EFECTIVO
=============================================*/
$(".FormularioAjuste").on("keyup", "input#nuevoValorEfectivo", function(){

	var efectivo = $(this).val();

	var cambio =  Number(efectivo) - Number($('#nuevoTotalAjuste').val());
...
CAMBIO TRANSACCIÓN
=============================================*/
$(".FormularioAjuste").on("change", "input#nuevoCodigoTransaccion", function(){
...
$(".btnEditarAjuste").click(function(){

	var idAjuste = $(this).attr("idAjuste");

	window.location = "index.php?ruta=editar-ajuste&idAjuste="+idAjuste;
...
$(".btnEliminarAjuste").click(function(){

  var idAjuste = $(this).attr("idAjuste");

  swal({
        title: '¿Está seguro de borrar la ajuste?',
        ...
        confirmButtonText: 'Si, borrar ajuste!'
      }).then((result) => {
        if (result.value) {

            window.location = "index.php?ruta=ajuste&idAjuste="+idAjuste;
        }
